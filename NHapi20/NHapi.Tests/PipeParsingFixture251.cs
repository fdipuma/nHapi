...
{
	public class PipeParsingFixture251
	{
		...
		[Theory]
		[InlineData("MSH|^~\\&|XPress Arrival||||200610120839||ORU^R01|EBzH1711114101206|P|2.5.1|||AL|||ASCII\r\n" +
		            "PID|1||1711114||Appt^Test||19720501||||||||||||001020006\r\n" +
		            "ORC|||||F\r\n" +
		            "OBR|1|||ehipack^eHippa Acknowlegment|||200610120839|||||||||00002^eProvider^Electronic|||||||||F\r\n" +
		            "OBX|1|DT|||DTValue||||||F\r\n" +
		...
		{
			string hl7Data =
				"MSH|^~\\&|CohieCentral|COHIE|Clinical Data Provider|TCH|20060228155525||ADT^A04|1|P|2.5.1|\r\n" +
				"EVN|\r\n" +
				"PID|1|12345\r\n" +
				"PV1|1";
